	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	<ul style="list-style-type: none;">
	        		<li><a href="{{route('ex1', $lessonshow->id)}}"> <button class="btn btn-info btn-lg"> Nghe >> </button></a></li>
	        		<br>
	        		<li><a href="{{route('ex2', $lessonshow->id)}}"> <button class="btn btn-info btn-lg"> Nói >> </button></a></li>
	        		<br>
